...
c8 = Vw_s_As(beta,7,A7)-Vw_s_As(beta,8,A8)-delta_s[8]-delta_l*db$late6
...
c7 = Vw_s_As(beta,6,A6)-EV8-delta_s[7]-delta_l*db$late6
...
c6 = Vw_s_As(beta,5,A5)-EV7-delta_s[6]-delta_l*db$late6
...
c5 = Vw_s_As(beta,5,A5)-EV7-delta_s[6]-delta_l*db$late6
...
c4 = Vw_s_As(beta,4,A4)-EV6-delta_s[5]-delta_l*db$late6
...
c3 = Vw_s_As(beta,3,A3)-EV7-delta_s[4]-delta_l*db$late6
...
c2 = Vw_s_As(beta,2,A2)-EV7-delta_s[3]-delta_l*db$late6
...
start= c(0.9,rep(-2,8),0)

optim(start,vraisemblance)
